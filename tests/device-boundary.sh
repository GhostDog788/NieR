...
"$NIER_SDK_ROOT/host/usr/lib/llvm-18/bin/clang" --config="$config" -O2 "$test_root/examples/hello/hello/main.c" "$test_root/examples/hello/hello/hello.c" -o "$test_work/hello.nier"
