...
- Keep toolchain correctness separate from the future signing and executable-memory enforcement platform. Source exclusion is not proof of reverse-engineering resistance.
