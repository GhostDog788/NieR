...
function(sela_add_publication name)
  cmake_parse_arguments(PARSE_ARGV 1 SELA "" "SOURCE_DIR;NATIVE_OUTPUT;OUTPUT;BUILD_TOOL"
    "ARCHS;BUILD_TARGETS;CONFIGURE_ARGS;CFLAGS")
  ...
  foreach(arch IN LISTS SELA_ARCHS)
    list(APPEND sela_arguments --arch "${arch}")
  endforeach()
  foreach(target IN LISTS SELA_BUILD_TARGETS)
    list(APPEND sela_arguments --build-target "${target}")
  endforeach()
