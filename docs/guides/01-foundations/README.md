...
Start here to understand the representation before the implementation. These
chapters assume ordinary C programming experience, but no compiler background.
...
Continue with [using the toolchain](../02-toolchain-users/README.md), or jump
straight to [publishing an existing C project](../02-toolchain-users/using-nier-with-your-c-project.md).
